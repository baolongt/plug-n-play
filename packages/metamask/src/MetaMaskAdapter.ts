// MetaMask Wallet Adapter for SIWE (Sign-In with Ethereum)
import { 
  Adapter, 
  Wallet, 
  BaseSiwxAdapter, 
...
// Configuration specific to MetaMask
...
/**
 * MetaMask wallet adapter implementation for SIWE (Sign-In with Ethereum)
 * Extends BaseSiwxAdapter to provide IC integration via Ethereum signatures
 */
export class MetaMaskAdapter extends BaseSiwxAdapter<MetaMaskAdapterConfig> {
  public readonly id: string = 'metamask';
  ...
  constructor(args: AdapterConstructorArgs<MetaMaskAdapterConfig>) {
    super(args);
