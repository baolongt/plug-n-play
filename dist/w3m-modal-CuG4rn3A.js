import { p as proxy, s as subscribeKey, q as subscribe, i, r as resetStyles, a as i$1, x, t as AlertController, e as elementStyles, o as colorStyles, R as RouterController, m as ChainController, d as AssetUtil, h as AssetController, u as ConstantsUtil, f as ConnectionController, E as EventsController, v as SIWXUtil, M as ModalController, O as OptionsController, C as ConnectorController, w as AccountController, j as SnackController, A as ApiController, T as ThemeController, y as initializeTheming, b as CoreHelperUtil, g as ConstantsUtil$1 } from "./index-Dpy1MNOO.js";
import { c as customElement, n, r, o, U as UiHelperUtil } from "./index-BTap8kAk.js";
const state = proxy({
  message: "",
  open: false,
  triggerRect: {
...
let W3mModal = class W3mModal2 extends i$1 {
  ...
  onNewNetwork(nextCaipNetwork) {
    ...
    const isSwitchingNamespace = ChainController.state.isSwitchingNamespace;
    const isUnsupportedNetwork = this.caipNetwork?.name === ConstantsUtil$1.UNSUPPORTED_NETWORK_NAME;
